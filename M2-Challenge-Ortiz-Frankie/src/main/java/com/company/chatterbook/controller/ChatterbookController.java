...
import com.company.chatterbook.modules.ChatterPost;
import com.company.chatterbook.modules.User;
...
public class ChatterbookController {
    ...
    //No error handling for incorrect name?
    ...
    public List<ChatterPost> getChatterPostsByUsername(@PathVariable String name){
        ...
        return userList.get(i).getChatterPosts();
    }
